...
function inicial() {
    ...
    if (opcionSeleccionada === "" || textoInput === "") {
      ...
      var enlaceGenerado = "https://celibertadorbolivar.github.io/web/boletas/inicial/" + opcionSeleccionada + "/" + textoInput + ".pdf";
...
function media() {
  ...
  if (opcionSeleccionada === "" || textoInput === "") {
    ...
    var enlaceGenerado = "https://celibertadorbolivar.github.io/web/boletas/media/" + opcionSeleccionada + "/" + textoInput + ".pdf";
    var resultadoElement = document.getElementById("resultado1");
  document.getElementById("resultado1").innerHTML= enlaceGenerado;
  window.location=document.getElementById("resultado1").innerHTML;
}
...
function certificacioncc() {
  ...
  if (opcionSeleccionada === "" || textoInput === "") {
    ...
    var enlaceGenerado = "https://celibertadorbolivar.github.io/web/documentos/certificacionescupos/" + opcionSeleccionada + textoInput + ".pdf";
    var resultadoElement = document.getElementById("resultado1");
  document.getElementById("resultado1").innerHTML= enlaceGenerado;
  window.location=document.getElementById("resultado1").innerHTML;
}
...
function inicialc() {
 ...
 if (textoInput === "") {
   ...
   var enlaceGenerado = "https://evaipcelb.github.io/celb/constancias/"+ textoInput + ".pdf";
...
function mediac() {
 ...
 if (textoInput === "") {
   ...
   var enlaceGenerado = "https://mediagenerale.github.io/celb/constancias/"+ textoInput + ".pdf";
   var resultadoElement = document.getElementById("resultado2");
 document.getElementById("resultado2").innerHTML= enlaceGenerado;
 window.location=document.getElementById("resultado2").innerHTML;
}
